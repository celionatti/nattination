    ...
    <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
        <section class="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
            ...
            <div class="hidden lg:relative lg:block lg:p-12">
                <a class="block text-white" href="<?= URL_ROOT ?>">
                ...
                <form action="#" class="mt-8 grid grid-cols-6 gap-6">
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input
                            ...
                            id="FirstName"
                            name="first_name"
                            class="p-2 mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200" />
                    </div>
                    ...
                    <div class="col-span-6 sm:flex sm:items-center sm:gap-4">
                        ...
                        <p class="mt-4 text-sm text-gray-500 sm:mt-0 dark:text-gray-400">
                            ...
                            <a href="<?= URL_ROOT . "/login" ?>" class="text-gray-700 underline dark:text-gray-200">Log in</a>.
                        </p>
                    </div>
                </form>
            </div>
